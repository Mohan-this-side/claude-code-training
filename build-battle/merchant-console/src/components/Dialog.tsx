    ...
    <DialogPortal>
      <DialogOverlay>
        <DialogPrimitives.Content
          ...
          className={cx(
            // base
            "fixed left-1/2 top-1/2 z-50 flex max-h-[85vh] w-[95vw] -translate-x-1/2 -translate-y-1/2 flex-col overflow-y-auto rounded-md border p-4 shadow-lg focus:outline-none sm:max-w-lg sm:p-6",
            // border color
